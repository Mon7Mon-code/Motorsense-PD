...
class AppTheme {
  ...
  static TextTheme get textTheme => GoogleFonts.dmSansTextTheme().copyWith(
    displayLarge:  GoogleFonts.dmSans(fontSize: 32, fontWeight: FontWeight.w600, color: neutral900, letterSpacing: -0.5),
    displayMedium: GoogleFonts.dmSans(fontSize: 26, fontWeight: FontWeight.w600, color: neutral900, letterSpacing: -0.3),
    titleLarge:    GoogleFonts.dmSans(fontSize: 20, fontWeight: FontWeight.w600, color: neutral900),
    titleMedium:   GoogleFonts.dmSans(fontSize: 16, fontWeight: FontWeight.w500, color: neutral900),
    titleSmall:    GoogleFonts.dmSans(fontSize: 14, fontWeight: FontWeight.w500, color: neutral700),
    bodyLarge:     GoogleFonts.dmSans(fontSize: 16, fontWeight: FontWeight.w400, color: neutral700, height: 1.6),
    bodyMedium:    GoogleFonts.dmSans(fontSize: 14, fontWeight: FontWeight.w400, color: neutral700, height: 1.5),
    bodySmall:     GoogleFonts.dmSans(fontSize: 12, fontWeight: FontWeight.w400, color: neutral500),
    labelLarge:    GoogleFonts.dmSans(fontSize: 14, fontWeight: FontWeight.w500, color: neutral900),
    labelSmall:    GoogleFonts.dmSans(fontSize: 11, fontWeight: FontWeight.w500, color: neutral500, letterSpacing: 0.5),
  );

  static TextStyle get mono => GoogleFonts.dmMono(fontSize: 13, color: neutral700);
  static TextStyle get monoLarge => GoogleFonts.dmMono(fontSize: 22, fontWeight: FontWeight.w500, color: neutral900);
  ...
  static ThemeData get light => ThemeData(
    ...
    appBarTheme: AppBarTheme(
      ...
      centerTitle: false,
      titleTextStyle: GoogleFonts.dmSans(fontSize: 18, fontWeight: FontWeight.w600, color: neutral900),
    ),
    ...
    inputDecorationTheme: InputDecorationTheme(
      ...
      border: OutlineInputBorder(borderRadius: BorderRadius.circular(12), borderSide: const BorderSide(color: neutral200)),
      enabledBorder: OutlineInputBorder(borderRadius: BorderRadius.circular(12), borderSide: const BorderSide(color: neutral200)),
      focusedBorder: OutlineInputBorder(borderRadius: BorderRadius.circular(12), borderSide: const BorderSide(color: teal600, width: 1.5)),
    ),
    ...
    dividerTheme: const DividerThemeData(color: neutral100, thickness: 0.5, space: 0),
  );
}
